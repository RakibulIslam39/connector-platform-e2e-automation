...
const PARTNER_SITE_SELECTORS = {
  ...
  BOL_COMPANY_NAME_FIELD: 'input[name*="company_name" i], input[placeholder*="Company Name" i]',
  BOL_COMPANY_EMAIL_FIELD: 'input[name*="company_email" i], input[type="email"]',
  BOL_COMPANY_PHONE_FIELD: 'input[name*="company_phone" i], input[type="tel"]',
  ...
  COLOR_OPTION_RADIO: 'input[type="radio"][name*="color" i], input[type="radio"][value*="color" i]',
