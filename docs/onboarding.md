...
test.describe('@connector @product My Feature', () => {
  ...
  test('@regression does the thing', async ({ partnerCreationPage, connectorApi }) => {
...
- Hypemill Onboarding Doc: https://docs.google.com/document/d/1GHPqssYvG91sxaeDxfHRwjfmxiwRB-Tfp-OAMxoVYNA
