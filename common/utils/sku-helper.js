...
function generateMasterSku(productBaseSku, selections) {
  ...
  if (selections.increaseDepth) {
    ...
    if (sku) {
      ...
      logger.warn(`[sku-helper] No IncreaseDepth mapping for: "${selections.increaseDepth}"`);
    }
  }
  ...
  if (selections.reduceHeight) {
    ...
    if (sku) {
      ...
      logger.warn(`[sku-helper] No ReduceHeight mapping for: "${selections.reduceHeight}"`);
    }
  }
  ...
  if (selections.crownMolding) {
    ...
    if (sku) {
      ...
      logger.warn(`[sku-helper] No CrownMolding mapping for: "${selections.crownMolding}"`);
    }
  }
  ...
  if (selections.crownMoldingFit) {
    ...
    if (sku) {
      ...
      logger.warn(`[sku-helper] No CrownMolding fit mapping for: "${selections.crownMoldingFit}"`);
    }
  }
  ...
  if (selections.extendChimney) {
    ...
    if (sku) {
      ...
      logger.warn(`[sku-helper] No ExtendYourChimney mapping for: "${selections.extendChimney}"`);
    }
  }
