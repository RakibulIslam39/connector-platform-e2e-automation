...
Enterprise-grade Playwright + JavaScript E2E automation for the Hoodsly
Connector Platform ecosystem.
...
```
fixtures/                ← Test fixtures; import { test, expect } from fixtures/index.js
                            (composed via Playwright mergeTests: page + api + auth)
pages/                   ← Page Object Model classes
tests/                   ← Test specs (19 spec files, 130 tests)
common/                  ← Reusable utilities, API services & domain helpers
                            (utils/, api/, actions/, auth/, runtime/, services/)
...
`BASE_URL`, `CONNECTOR_API_BASE_URL`, `CONNECTOR_API_SIGNATURE`, `HUB_BASE_URL`,
`WRH_HUB_BASE_URL`, `WIKS_HUB_BASE_URL`, `WP_ADMIN_USER`, `WP_ADMIN_PASS`,
`WP_PARTNER_USER`, `WP_PARTNER_PASS`, `HUB_ADMIN_USER`, `HUB_ADMIN_PASS`
...
_Framework by Rakibul Islam — Hypemill QA Team_
