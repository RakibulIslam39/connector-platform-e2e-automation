...
class PartnerSitePluginPage extends BasePage {
  constructor(page) {
    ...
    this.installedPluginsSubLink = page.locator('#menu-plugins .wp-submenu a[href*="plugins.php"]');
    this.pluginSearchInput = page.locator(PARTNER_SITE_SELECTORS.PLUGIN_SEARCH_INPUT).first();

    // Settings navigation
    this.settingsMenuLink = page.locator('div.wp-menu-name').filter({ hasText: /^Settings$/ });
