...
**Prerequisite**: WordPress admin authenticated; product with partners assigned
exists  
**Live Data** (verified 2026-06-02): Double Curved (VEN-DBC, id=5082) has
TestRakibulQA partner with full price data
...
- **Price Overrides**: Override the base price of any attribute value for a
  specific partner

This is a critical feature for B2B pricing differentiation (different prices for
different resellers).
...
**Purpose**: Verify the Partners tab in product edit form shows expandable
partner sections.
...
- Tab description: "Select which partners can access this product. You can set
  custom titles, SKUs, and price overrides per partner."
...
**Purpose**: Verify that a custom title can be set for a partner's product
listing.
...
- On save: the custom title is sent to the partner site in place of the default
  product title
...
**Purpose**: Verify that a custom SKU can be set for a partner's product
listing.
...
**Purpose**: Verify the price override table shows all attribute values
...
**Purpose**: Verify that entering a partner price override saves and is
reflected in sync payload.
