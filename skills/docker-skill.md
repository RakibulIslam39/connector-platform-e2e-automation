...
## Dockerfile Notes
- Base: `mcr.microsoft.com/playwright:v1.52.0-noble` — includes Node.js + all browser binaries
- `npm ci --ignore-scripts` — skip postinstall scripts, browsers already in base image
