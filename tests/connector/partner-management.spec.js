...
test.describe('Product Management — partner assignment & description', () => {
  ...
  test('assign partner to product using Partners tab checkbox', async ({ productManagementPage }) => {
  ...
  test('remove partner from product using Partners tab checkbox', async ({ productManagementPage }) => {
