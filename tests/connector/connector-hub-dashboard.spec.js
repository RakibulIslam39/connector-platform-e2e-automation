...
//   test('@smoke TC-DASH-001: should navigate to Dashboard via sidebar submenu and validate all sections', async ({
//     connectorHubDashboardPage,
//   }) => {
...
//         )
//         .toBeTruthy();
//       expect.soft(platform.percentage, `${platform.platform} percentage`).toMatch(/^\d+%$/);
//     }
...
//     await expect.soft(connectorHubDashboardPage.settingsRow).toHaveAttribute('href', '#/settings');
//   });
// });
