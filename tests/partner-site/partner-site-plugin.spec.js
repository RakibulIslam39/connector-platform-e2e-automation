...
//     test('@smoke Hoodsly Partners Connector plugin is searchable on Plugins page', async ({
...
//     test('can navigate to Hoodsly connector settings page', async ({ partnerSitePluginPage }) => {
...
//     test('update API key — saves and shows success message', async ({ partnerSitePluginPage }) => {
...
//     test('Import tab is visible on connector settings page', async ({ partnerSitePluginPage }) => {
//       await partnerSitePluginPage.navigateToConnectorSettings();
